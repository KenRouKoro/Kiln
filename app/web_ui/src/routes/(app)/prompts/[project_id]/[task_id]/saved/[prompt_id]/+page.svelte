  ...
  $: {
    prompt_props = Object.fromEntries(
      Object.entries({
        ...
        [$_('prompts.saved_prompt.details_fields.description')]: prompt_model?.description,
        [$_('prompts.saved_prompt.details_fields.created_by')]: prompt_model?.created_by,
        [$_('prompts.saved_prompt.details_fields.created_at')]: formatDate(prompt_model?.created_at || undefined),
        [$_('prompts.saved_prompt.details_fields.chain_of_thought')]: prompt_model?.chain_of_thought_instructions
          ? $_('common.yes')
          : $_('common.no'),
        [$_('prompts.saved_prompt.details_fields.source_generator')]: prompt_model?.generator_id
          ? prompt_name_from_id(
...
<div class="max-w-[1400px]">
  ...
  >
    ...
    {:else if prompt_model}
      <div class="flex flex-col xl:flex-row gap-8 xl:gap-16 mb-8">
        ...
        <div class="w-[320px] 2xl:w-96 flex-none flex flex-col gap-4">
          <div class="text-xl font-bold">{$_('prompts.saved_prompt.details')}</div>
          <div
    ...
    {:else}
      <div class="text-error">{$_('prompts.saved_prompt.prompt_not_found')}</div>
    {/if}
  </AppPage>
</div>
