<script lang="ts">
  ...
  function example_project() {
    project.name = $_('project.example_project_name')
    project.description = $_('project.example_project_description')
  }
</script>
