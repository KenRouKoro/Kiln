...
<div>
  <div class="form-control">
    <label class="label cursor-pointer flex flex-row gap-3">
      ...
      />
      <span class="label-text text-left grow">{$_('task.schema_section.plain_text')}</span>
    </label>
  </div>
  <div class="form-control">
    <label class="label cursor-pointer flex flex-row gap-3">
      <input
        ...
        bind:group={plaintext}
      />
      <span class="label-text text-left grow">{$_('task.schema_section.structured_json')}</span>
    </label>
  </div>
