...
export function schema_from_model(
  ...
  for (let i = 0; i < m.properties.length; i++) {
    ...
    if (!safe_name) {
      throw new KilnError(
        get(_)('json_schema.errors.property_special_chars', { values: { name: m.properties[i].title } }),
        null,
      )
    }
...
export function typed_json_from_schema_model(
  ...
  for (const [prop_id, prop_value] of Object.entries(data)) {
    ...
    if (!property) {
      throw new KilnError(
        get(_)('json_schema.errors.property_not_allowed', { values: { property: prop_id } }),
        null,
      )
    }
    if (property.type === "string") {
      ...
      errors.push(get(_)('json_schema.errors.empty_string_non_string', { values: { property: prop_id } }))
    } else if (property.type === "number") {
      parsed_data[prop_id] = Number(prop_value)
    } else if (property.type === "boolean") {
      if (prop_value !== "true" && prop_value !== "false") {
        errors.push(get(_)('json_schema.errors.boolean_invalid', { values: { property: prop_id } }))
      }
      ...
      if (!Number.isInteger(parsedValue)) {
        errors.push(
          get(_)('json_schema.errors.integer_invalid', { values: { property: prop_id, value: prop_value } })
        )
      }
      ...
      try {
        ...
        if (!Array.isArray(parsed_value)) {
          errors.push(
            get(_)('json_schema.errors.array_invalid', { values: { property: prop_id, value: prop_value } })
          )
        }
        parsed_data[prop_id] = parsed_value
      } catch (e) {
        errors.push(
          get(_)('json_schema.errors.array_json_invalid', { values: { property: prop_id, value: prop_value } })
        )
      }
      ...
      try {
        ...
        if (
          ...
          errors.push(
            get(_)('json_schema.errors.object_invalid', { values: { property: prop_id, value: prop_value } })
          )
        }
        parsed_data[prop_id] = parsed_value
      } catch (e) {
        errors.push(
          get(_)('json_schema.errors.object_json_invalid', { values: { property: prop_id, value: prop_value } })
        )
      }
    } else {
      errors.push(
        get(_)('json_schema.errors.unsupported_type', { values: { type: property.type, property: property.id } })
      )
    }
  }
  for (const model_prop of m.properties) {
    if (
      ...
      errors.push(get(_)('json_schema.errors.required_property_missing', { values: { property: model_prop.id } }))
    }
  }
  if (errors.length > 0) {
    throw new KilnError(
